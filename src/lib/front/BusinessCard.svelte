<script>
  ...
  $: telLink = `${vCardOptions.contact.phone.countryCode ? `+${vCardOptions.contact.phone.countryCode}` : ''}${vCardOptions.contact.phone.number}${
    vCardOptions.contact.phone.extension ? `,${vCardOptions.contact.phone.extension}` : ''
  }`;

  let formattedNumber;
  $: formattedNumber = `${vCardOptions.contact.phone.countryCode ? `(+${vCardOptions.contact.phone.countryCode})` : ''} ${vCardOptions.contact.phone.number}`;
</script>
